...
void test(){
    ...
    printf("\n     Bon nombre d'̩l̩ment dans la stack ?\n");
    if(stackSize(s) == 0){
        printf(" -> Bien vu l'aveugle ^^\n");
    }
    else{
    ...
    item = top(s, &valid);
    printf("\n     V̩rification de la bonne valeur du top\n");
    if(item == 3 && valid == 1){
        printf(" -> Bien vu l'aveugle ^^\n");
    }
    else{
